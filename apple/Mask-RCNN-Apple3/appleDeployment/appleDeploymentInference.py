...
weights_path = os.path.join(ROOT_DIR, "appleDeployment", "model_logsDeployment", "apple20230708T1131_0.9",
                            "mask_rcnn_apple_0020.h5")
...
fullname1 = 'E:/!DeepTechnology/!Customers/!2023/Seth Software EOSC-AI4Pheno/AI4PhenoEOSC/apple/Mask-RCNN-Apple/apple_dataset/apple/test1/20220710_1204_0700F136_PIC_84_CAM_2.xml.pi.jpg'
image = load_image(fullname1)
dirname, filename = os.path.split(fullname1)
