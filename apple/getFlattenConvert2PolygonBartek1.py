...
def convert_circle_to_polygon(input_path, output_path):
    ...
    output_data = {}
    empty_cases = 0  # Licznik przypadków, w których funkcja zwroc_maske zwraca None
    ...
    print(f"Liczba przypadków z pustą maską: {empty_cases}")

# Dalsza część kodu, jeśli istnieje (np. wywołanie głównej funkcji, obsługa wyjątków itp.)
