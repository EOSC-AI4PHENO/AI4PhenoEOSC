...
def odtworz_model(jitfile, image_file, nr_karty, path_to_results):
    ...
    with open(f"{path_to_results}/{file_prefix}_jit_pred_json_Jr.json", "w") as fp:
...
image_file = 'input/001_20230818062050_[R][0@0][0].jpg'

#path_to_results = '/home/swidersb/bswiderski/data/wyniki_tmp/'
path_to_results = 'wyniki_tmp/'
jitfile = 'savedmodel/model4.jit'
...
odtworz_model(jitfile, image_file, nr_karty, path_to_results)
>>>>>>> 2b432455bc3b9609aae2a206c9d035ee9a2357bc
