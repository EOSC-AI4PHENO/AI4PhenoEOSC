...
weights_path = os.path.join(ROOT_DIR, "model_logsDeployment", "apple20230708T1131_0.9",
...
model.keras_model.save('AppleMaskRCNNModelv1', save_format='tf')  # gdzie model_path to ścieżka, do której chcesz zapisać model
