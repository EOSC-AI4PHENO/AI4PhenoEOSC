...
weights_path = os.path.join(ROOT_DIR, "model_logsDeployment", "apple20230820T0249",
                            "mask_rcnn_apple_0100.h5")
...
model.keras_model.save('AppleMaskRCNNModelv3', save_format='tf')  # gdzie model_path to ścieżka, do której chcesz zapisać model
