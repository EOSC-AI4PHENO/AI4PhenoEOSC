...
from .modelLindenJarek import MaskRCNN
...
class LindenSegmentationModel:
    ...
    def get_linden_automatic_rois(self, imageRGB: np.ndarray, image_size: int, height: int, width: int, filename: str,
    ...
    def get_linden_automatic_rois_with_indicators(self, imageRGB: np.ndarray, image_size: int, height: int, width: int, filename: str,
        ...
        if jsonBase64ImageROIs is None:
            ...
            return filename, json_linden_rois_b64, r_av, g_av, b_av, r_sd, g_sd, b_sd, bri_av, bri_sd, gi_av, gei_av, gei_sd, ri_av, ri_sd, bi_av, bi_sd, gi_sd, avg_width, avg_height, avg_area, number_of_apples
        else:
            jsonBase64ImageROIsPolygon = Convert2Polygon.Convert2Polygon2(jsonBase64ImageROIs, width, height)
            json_linden_rois_b64_filtered = roi_intersection.filter_json_file1(jsonBase64ImageROIsPolygon, json_linden_rois_b64, width, height)
