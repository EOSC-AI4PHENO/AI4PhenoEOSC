...
import sys
import numpy as np
from linden import LindenDataset
...
# config.display()
##############################################################################
LINDEN_DIR = os.path.join(ROOT_DIR, 'linden_dataset', 'linden')

train_ds = LindenDataset()
val_ds = LindenDataset()

# load data
train_ds.load_linden(LINDEN_DIR, 'train')
val_ds.load_linden(LINDEN_DIR, 'val')
