...
def is_image_well_exposedByHisto(image_path, low_threshold=0.3, high_threshold=0.7):
...
def process_images_in_folder(folder_path):
    ...
    for filename in tqdm(os.listdir(folder_path), desc=f'Processing images in {folder_path}'):
        ...
        if filename.endswith(".jpg") or filename.endswith(".png"):
            ...
            result, message, cumulative_hist = is_image_well_exposedByHisto(full_path, 0.1, 0.99)
