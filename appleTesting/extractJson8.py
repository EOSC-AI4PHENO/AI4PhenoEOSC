...
def copy_jpg_and_json(input_dir: str):
    ...
    PNG images are converted to JPG. File extensions for images are in lower case.
                ...
                with open(os.path.join(dirpath, filename), 'r') as f:
                    ...
                    for key, item in data.items():
                        ...
                        if file_extension in ['jpg', 'jpeg', 'png'] and os.path.exists(
                            ...
                            new_image_filename = f"{folder_prefix}_{image_filename.rsplit('.', 1)[0]}.{file_extension}"
